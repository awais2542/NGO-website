  ...
  return (
    <div className="min-h-screen bg-white mt-2">
      ...
      <div className="text-center py-8 px-4">
        <h2 className="text-xl sm:text-2xl md:text-3xl font-semibold text-destructive">
          Our Vision
        </h2>

        <p className="mt-4 text-lg sm:text-xl md:text-2xl font-medium text-gray-800">
      ...
      <div className="text-center py-8 px-4">
        ...
        <p className="mt-2">
          All our functions are operating through the understanding of <br />
