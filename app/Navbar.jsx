    ...
    <nav className="relative bg-card text-black ">
        ...
        <div className="flex items-center justify-between h-25">
          ...
          <div className="hidden md:block items-center ">
            <div className="ml-4 flex items-center-safe gap-6 md:ml-6">
              <Link
                href="/"
                className="nav-link text-black hover:bg-muted rounded-lg p-2"
              >
                Home
              </Link>
          ...
          <div className="md:hidden flex items-center">
            <button
              className="inline-flex items-center justify-center p-2 rounded-xbg-muted                          hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white"
      ...
      {isClick && (
        <div className="md:hidden px-4 pb-4 space-y-2 bg-accent-foreground">
          <Link
            href="#"
            className="block text-black hover:bg-muted rounded-lg p-2"
          >
            Home
          </Link>
          <DropdownMenuDemo />
